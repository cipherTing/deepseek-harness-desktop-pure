...
export const zh = {
  ...
  'dialog.savedTitle': 'Session 导出完成',
  'dialog.savedDescription': 'Session ZIP 文件已保存到所选位置。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'dialog.savedTitle': 'Session export complete',
  'dialog.savedDescription': 'The Session ZIP was saved to the selected location.',
