...
This decision replaces only the Desktop-only builder and query placement; Desktop installation and platform signing stay with the carrier's own release rules.
